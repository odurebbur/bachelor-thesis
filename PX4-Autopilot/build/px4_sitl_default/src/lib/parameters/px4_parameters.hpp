...
static constexpr param_info_s parameters[] = {
	...
	{
		.name = "EKF2_RNGBC_CTRL",
		.val = { .i = 0},
	},

	{
		.name = "EKF2_RNGBC_DELAY",
		.val = { .f = 0 },
	},

	{
		.name = "EKF2_RNGBC_GATE",
		.val = { .f = 5.0 },
	},

	{
		.name = "EKF2_RNGBC_NOISE",
		.val = { .f = 30.0 },
	},
	...
	{
		.name = "GPS_UBX_JAM_DET",
		.val = { .i = 1},
	},

	{
		.name = "GPS_UBX_MIN_CNO",
		.val = { .i = 0},
	},

	{
		.name = "GPS_UBX_MIN_ELEV",
		.val = { .i = 0},
	},
	...
	{
		.name = "MOTFAIL_HIGH_OFF",
		.val = { .f = 10.0 },
	},

	{
		.name = "MOTFAIL_LOW_OFF",
		.val = { .f = 10.0 },
	},
	...
	{
		.name = "SIM_GZ_EC_DIS10",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS11",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS12",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS13",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS14",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS15",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_DIS16",
		.val = { .i = 0},
	},
	...
	{
		.name = "SIM_GZ_EC_FAIL10",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL11",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL12",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL13",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL14",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL15",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_EC_FAIL16",
		.val = { .i = -1},
	},
	...
	{
		.name = "SIM_GZ_EC_FUNC10",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC11",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC12",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC13",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC14",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC15",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_FUNC16",
		.val = { .i = 0},
	},
	...
	{
		.name = "SIM_GZ_EC_MAX10",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX11",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX12",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX13",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX14",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX15",
		.val = { .i = 1000},
	},

	{
		.name = "SIM_GZ_EC_MAX16",
		.val = { .i = 1000},
	},
	...
	{
		.name = "SIM_GZ_EC_MIN10",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN11",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN12",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN13",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN14",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN15",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_EC_MIN16",
		.val = { .i = 0},
	},
	...
	{
		.name = "SIM_GZ_SV_MAXA1",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA2",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA3",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA4",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA5",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA6",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA7",
		.val = { .f = 45.0 },
	},

	{
		.name = "SIM_GZ_SV_MAXA8",
		.val = { .f = 45.0 },
	},
	...
	{
		.name = "SIM_GZ_SV_MINA1",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA2",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA3",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA4",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA5",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA6",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA7",
		.val = { .f = -45.0 },
	},

	{
		.name = "SIM_GZ_SV_MINA8",
		.val = { .f = -45.0 },
	},
	...
	{
		.name = "SIM_GZ_WH_FAIL3",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_WH_FAIL4",
		.val = { .i = -1},
	},
	...
	{
		.name = "SIM_GZ_WH_FUNC3",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_WH_FUNC4",
		.val = { .i = 0},
	},
